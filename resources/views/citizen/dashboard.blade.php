    ...
    <div class="dashboard-content">
        <div class="container">
            ...
            <div id="gemini-chatbot"
                style="position:fixed; bottom:20px; right:20px; width:350px; max-width:90%; background:white; border-radius:15px; box-shadow:0 4px 10px rgba(0,0,0,0.2); overflow:hidden; display:flex; flex-direction:column; z-index:9999; font-family:sans-serif;">
                <div id="chat-header"
                    style="  background: var(--primary-color); color: white;border-radius: 50%; width: 60px; height: 60px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; cursor: pointer;box-shadow: var(--shadow);">
                    💬
                </div>
                <div id="chat-body"
                    style="flex:1; padding:10px; display:none; flex-direction:column; overflow-y:auto; max-height:400px;">
                    ...
                    <div style="display:flex; gap:5px;">
                        ...
                        <button id="chat-send"
                            style="padding:8px 12px; border:none; background:#3b82f6; color:white; border-radius:10px; cursor:pointer;">إرسال</button>
                    </div>
                </div>
            </div>
